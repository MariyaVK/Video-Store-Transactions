...
public class Video implements Comparable<Video>
{
    ...
    {
    	if (n<=0) throw new IllegalArgumentException();
    	else if (numRentedCopies == numCopies) throw new AllCopiesRentedOutException();
    	else if (n + numRentedCopies > numCopies) numRentedCopies = numCopies;
    ...
    {
    	if (n<=0) throw new IllegalArgumentException();
    	else if (n > numRentedCopies) numRentedCopies = 0;
    	else numRentedCopies -= n;
    }
